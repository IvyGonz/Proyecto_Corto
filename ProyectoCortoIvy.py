# -*- coding: utf-8 -*-
"""
Created on Sat Mar 21 21:42:58 2020

@author: IvyGonz
"""
# los archivos .txt sera dirigidos a una carpeta llamada "Datos de los casos" en la carpera "Documents" Antes de
# iniciar el programa, para que el metodo "actualizar_datos" funcione correctamente, se debe mover el archivo .py a
# la carpeta creada por el programa
...
class Registro_Pandemia:
    ...
    # tomar en cuenta los sintomas del resfriado comun y la alergia:
    @staticmethod
...
def Menu1():
    ...
    while opcion != '0':
        print("-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-")
        print("|  ¡ALERTA PANDEMIA COVID-19!   |")
        print("|        #quedateencasa         |")
        print("|                               |")
        ...
        if opcion == '1':
            ...
            if not registrar_datos:
                print('---¡Actualmente no hay pacientes en el registro!---')
                print("-- presione ENTER para continuar --")
                input()
                Menu1()
            else:
                while True:
                    ...
                    if Nombre + '\n' == open("Nombre.txt").read() and ID + '\n' == open("ID.txt").read():
                        ...
                        print("")
                        print("---¿A que desea actualizar el estatus?---")
                        print("")
                        print("1- Sospechoso")
                        print("2- Activo")
                        print("3- Descartado")
